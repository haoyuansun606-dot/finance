...
from data_loader import DATA_DIR, MULTI_COUNTRY_OTHER, _fetch_etf, _fetch_yfinance
from metrics import performance_summary
from strategy_grouped import GroupedBacktestConfig, run_grouped_adaptive_stocks, run_grouped_band_rebalance

plt.rcParams["font.sans-serif"] = ["SimHei", "Microsoft YaHei", "Arial Unicode MS", "DejaVu Sans"]
plt.rcParams["axes.unicode_minus"] = False

OUTPUT_DIR = Path(__file__).resolve().parent / "output" / "v4_extended"
...
def plot_compare(summary: pd.DataFrame) -> Path:
    ...
    names = [SCHEME_LABELS.get(s, s) for s in summary["scheme"]]
    ...
    fig.suptitle("V4 扩展全球股票池 + 永久组合 (10国/区 + 债/货/金)", fontsize=12)
    fig.tight_layout()
    path = OUTPUT_DIR / "compare_sharpe_drawdown.png"
